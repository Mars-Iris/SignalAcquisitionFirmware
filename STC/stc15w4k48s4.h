...
sfr PCON2     =   0x97;   //0000,0000 时钟分频控制寄存器
...
#define		S1_Int_on()			    ES =  1;	//串口1允许中断
#define		S1_Int_off()			  ES =  0;	//串口1禁止中断
...
#define		S2_Int_on()			 IE2   |=  1		//串口2允许中断
#define		S2_Int_off()		 IE2   &= ~1;	//串口2禁止中断
...
#define		S3_Int_on()			  IE2   |=  0x08;		//串口3允许中断
#define		S3_Int_off()			IE2   &= ~0x08;	  //串口3禁止中断
...
#define		S4_Int_on()			  IE2   |=  0x10;		//串口4允许中断
#define		S4_Int_off()			IE2   &= ~0x10;	  //串口4禁止中断
