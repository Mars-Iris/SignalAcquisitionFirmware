...
//配置板号，详细定义见check.h
#define BOARD_NO   HN_YZ_JJZD_KM2 //湖南省永州市交警支队支队科目二125
...
//配置主板与上位机连接的串号
#define UPLOAD_USART				USART2			//可选USART1，USART2，USART3，USART4	
...
//配置GPS板卡与主板连接的串口号
#define GPS_USART						USART3			//可选USART1，USART2，USART3，USART4,DISABLE	

#define GPS_BAUDRATE				38400L			//可选2400L,4800L,9600L,19200L,38400L,115200L，该值最后被软件自动配置为38400

//配置高森碰杆传感器与主板之间连接的串口号
#define HS_BUMP_USART				USART4			//可选USART1，USART2，USART3，USART4,DISABLE
...
#define TILT_MTC_USART			USART1			//可选USART1，USART2，USART3，USART4,DISABLE,二轮摩托车与主板连接的串口号
